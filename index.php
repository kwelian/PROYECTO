            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <img src="imagenes/user_edit_icon_241064.png" class="card-img-top" alt="Aprendiz">
                                <div class="card-body">
                                    <h5 class="card-title">Aprendiz</h5>
                                    <p class="card-text">Vea las citaciones del aprendiz.</p>

                                    <div class="d-grid gap-2 col-6 mx-auto text-center">
                                        <a href="vista_alumnos.php" class="btn btn-success" type="button">Ir a la página alumnos</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-grid gap-2 col-6 mx-auto text-center">
                                        <a href="vista_cursos.php" class="btn btn-success" type="button">Ir a la página de citaciones</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-grid gap-2 col-6 mx-auto text-center">
                                        <a href="gestionar_archivos.php" class="btn btn-success" type="button">Ir a gestionar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
